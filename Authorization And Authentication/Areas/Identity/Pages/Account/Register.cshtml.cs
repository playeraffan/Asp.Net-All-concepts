...
namespace Authorization_And_Authentication.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            [Required]
            [MaxLength(255 , ErrorMessage ="firstname lenght must be lessthen 255")]
            [Display(Name = "firstName")]
            public string firstName { get; set; }


            [Required]
            [MaxLength(255, ErrorMessage = "lastname lenght must be lessthen 255")]
